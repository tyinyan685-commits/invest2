...
4. 每个核心观点必须给 evidenceIds。可用：fmp:quote、fmp:aftermarket、fmp:profile、fmp:financials、fmp:estimates、fmp:technicals、fmp:insiders、fmp:filings、fmp:filing-text、fmp:earnings、fmp:macro、fmp:sentiment、longbridge:quote、news:N。
...
10. 当前价校准优先级：marketData.longbridge（未来代理） > marketData.aftermarket.quote/trade > marketData.quote。若长桥存在，用 longbridge:quote；若 FMP aftermarket 存在，用 fmp:aftermarket；技术指标仍以 FMP 日线为准。
